   ...
   if( NOT MULLE_CURL_LIBRARY)
      ...
      if( MULLE_CURL_LIBRARY)
         ...
         if( NOT NO_INHERIT_OBJC_DEPS)
            foreach( _TMP_MULLE_CURL_NAME "MulleCurl")
               set( _TMP_MULLE_CURL_FILE "${_TMP_MULLE_CURL_ROOT}/include/${_TMP_MULLE_CURL_NAME}/MulleObjCDeps+${_TMP_MULLE_CURL_NAME}.h")
               if( EXISTS "${_TMP_MULLE_CURL_FILE}")
                  list( APPEND INHERITED_OBJC_DEPS ${_TMP_MULLE_CURL_FILE})
                  break()
               endif()
            endforeach()
         endif()
